...
const empInfoSchema = Joi.object({
  ...
  firstName: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).required().trim().allow(' ').messages({
  ...
  lastName: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).required().trim().allow('').messages({
  ...
  age: Joi.number().integer().min(21).max(60).required().messages({
  ...
  // }),
  skills: Joi.array().items(Joi.string()).min(1).messages({
    'array.base': 'Skills must be an array.',
    'array.min': 'At least one skill is required.',
    'array.unique': 'Skills must be unique.',
    'string.base': 'Each skill must be a string.',
  }),
  experience: Joi.number().integer().min(1).max(40).required().messages({
  ...
  salary: Joi.number().min(10000).max(2000000).required().messages({
    'number.base': 'Salary must be a number',
    'number.min': 'Salary must be at least 10000',
    'number.max': 'Salary must not exceed 2000000',
    'any.required': 'Salary is required',
  }),
  AadharNo: Joi.string().pattern(/^\d{12}$/).required().messages({
  ...
  FatherName: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).trim().allow('').required().messages({
  ...
  MotherName: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).trim().allow('').required().messages({
  ...
  Father_occupation: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).trim().allow('').required().messages({
  ...
  Mother_Occupation: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(25).trim().allow('').required().messages({
  ...
  college_name: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(50).trim().allow('').required().label('Education').messages({
  ...
  degree: Joi.string().pattern(/^[A-Za-z\s]+$/).min(1).max(50).trim().allow('').required().label('Degree').messages({
  ...
  stream: Joi.string().pattern(/^[A-Za-z\s]+$/).min(1).max(50).trim().allow('').required().label('Stream').messages({
  ...
  cgpa: Joi.number().min(1).max(10).required().label('CGPA').messages({
  ...
  location: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(50).trim().allow('').required().label('City').messages({
  ...
  HSC_School_name: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(50).trim().allow('').required().label('HSC School Name').messages({
  ...
  HSC_Percentege: Joi.number().required().min(1).max(100).label('HSC Percentage').messages({
  ...
  SSLC_School_name: Joi.string().pattern(/^[A-Za-z\s]+$/).min(3).max(50).trim().allow('').required().label('SSLC School Name').messages({
  ...
  SSLC_Percentege: Joi.number().required().min(1).max(100).label('SSLC Percentage').messages({
  ...
  DoorNo: Joi.string().required().label('Door No').messages({
    'any.required': 'Door No is required',
  }),

  street_name: Joi.string().min(3).max(50).trim().allow('').required().label('Street Name').messages({
  ...
  Area: Joi.string().required().min(3).max(50).trim().allow('').label('Area').messages({
    'string.min': 'Area must be at least 3 characters long',
    'string.max': 'Area must not exceed 50 characters',
    'any.required': 'Area is required',
  }),

  city: Joi.string().required().min(3).max(50).trim().allow('').label('City').messages({
    'string.min': 'City must be at least 3 characters long',
    'string.max': 'City must not exceed 50 characters',
    'any.required': 'City is required',
  }),

  state: Joi.string().required().min(3).max(50).trim().allow('').label('State').messages({
    'string.min': 'State must be at least 3 characters long',
    'string.max': 'State must not exceed 50 characters',
    'any.required': 'State is required',
  }),

  pincode: Joi.string().pattern(/^\d{6}$/).required().label('Pincode').messages({
    'string.pattern.base': 'Pincode must be a 6-digit number',
    'any.required': 'Pincode is required',
  }),

  country: Joi.string().required().min(3).max(50).valid('India', 'USA', 'UK').trim().allow('').label('Country').messages({
